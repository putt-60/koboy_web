    ...
    <div className="bg">
      <Container className="keranjang-wrapper">
        ...
        {cart.map((item, idx) => (
          <div
            key={idx}
            className={`keranjang-item-box ${
              item.selected ? "keranjang-selected" : ""
            }`}
          >
            <Form.Check
              type="checkbox"
            ...
            <div
              className="keranjang-click-area"
            ...
            >
              ...
              <div className="keranjang-info">
                ...
                {item.variasi && (
                  <div className="keranjang-opsi">Pilihan: {item.variasi}</div>
                )}
                {item.note && (
                  <div className="keranjang-note">Catatan: {item.note}</div>
                )}
              </div>
            </div>
          </div>
